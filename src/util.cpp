...
const char * const BITCOIN_CONF_FILENAME = "atec.conf";
const char * const BITCOIN_PID_FILENAME = "atec.pid";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "ATEC";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/ATEC";
#else
    // Unix
    return pathRet / ".atec";
#endif

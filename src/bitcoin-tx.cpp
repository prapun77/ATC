...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || IsArgSet("-?") || IsArgSet("-h") || IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s atec-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  atec-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded atec transaction") + "\n" +
              "  atec-tx [options] -create [commands]   " + _("Create hex-encoded atec transaction") + "\n" +
              "\n";
